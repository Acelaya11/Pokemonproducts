  ...
  return (
    <form noValidate className={`space-y-4 ${className}`}>
      <div className="space-y-2">
        <Label className="text-white" htmlFor="email1">Email Address</Label>
        <Input
          id="email1"
          type="email"
          ...
          className={`w-full p-2 border border-gray-200 bg-white rounded-md focus:border-purple-500 focus:ring-1 focus:ring-purple-500 ${showErrors && error ? "border-red-500" : ""}`}
        />
      </div>
      <div className="space-y-2">
        <Label className="text-white" htmlFor="email2">Confirm Email Address</Label>
        <Input
          id="email2"
          type="email"
